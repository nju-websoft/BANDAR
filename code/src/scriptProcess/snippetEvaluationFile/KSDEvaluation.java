...
public class KSDEvaluation {
    ...
    private static void evaluateKSDSnippet(String folder, List<String> keywords, List<String>querywords){
        try {
            File file = new File(folder + "/ksd-snippet.txt");
            if (!file.exists()) {
        ...
        String snippetStr = ReadFile.readString(folder + "/ksd-snippet.txt").get(1);
...
//        evaluateKSDSnippet(baseFolder, keywords, keywords);
//
//    }
}
