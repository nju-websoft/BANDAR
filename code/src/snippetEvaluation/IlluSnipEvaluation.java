...
public class IlluSnipEvaluation {
    ...
    private void evaluateIlluSnip(int dataset, ArrayList<String> keywords, ArrayList<String>querywords){
        Connection connection = new DBUtil().conn;
        String select = "select snippet from snippet where algorithm = 'IlluSnip' and dataset_local_id = " + dataset + " limit 1";
        try {
    ...
    public static void main(String[] args){
        IlluSnipEvaluation test = new IlluSnipEvaluation();
        ...
        test.evaluateIlluSnip(1, keywords, keywords);
    }
}
